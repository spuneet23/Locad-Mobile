        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Ad-spent</span>
              <div class="count" >2500</div>
<!--              <span class="count_bottom"><i class="green">4% </i> From last Week</span>-->
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> Impression</span>
              <div class="count" id="impressions_count">123.50</div>
<!--              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>-->
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Clicks</span>
              <div class="count green" id="clicks_count">2,500</div>
<!--              <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From last Week</span>-->
            </div>
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> conversions</span>
              <div class="count" id="conversions_count">4,567</div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>Hourly impressions vs clicks</h3>
                  </div>
                  <div class="col-md-6">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  ...
                  <div style="width: 100%;">
                    <h5> <i class="fa fa-circle" style="color:#49B9FF"></i> Impression <i class="fa fa-circle" style="color:#FF7649"></i> Clicks </h5>
                    <div class="demo-placeholder" id="line-chart" style="width: 100%; height:270px;"></div>
                  </div>
                </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="tile_info">
                          ...
                          <tr>
                            <td>
                              <p><i class="fa fa-square green"></i>IE</p>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square purple"></i>Firefox</p>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square aero"></i>Opera</p>
                            </td>
                          </tr>
                          <tr>
                            <td>
                              <p><i class="fa fa-square red"></i>Navigator</p>
                            </td>
                          </tr>
                        </table>
                      </td>
